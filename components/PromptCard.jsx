  ...
  return (
    <div className='prompt_card'>
      <div className  = "flex justify-between items-start gap-5">
       ...
       <div className='flex-1 items-center flex justify-start gap-3 cursor-pointer' onClick = {handleProfileClick}>
      ...
      <p className='font-inter cursor-pointer text-sm blue_gradient' onClick = {() => handleTagClick && handleTagClick(post.tag)}>#{post.tag}</p>
      {session?.user.id === post.creator._id && pathName === '/profile' && (<div className='mt-5 flex-center gap-4 border-t border-gray-100'>
